...
return [
    ...
    'forms' => [
        ...
        'notice' => '<ul>
                ...
                <li>Чтобы в канал не выводилось название Места при снятой галочке строка с адресом должна содержать в 🏢</li>
                <li>Чтобы в канал не выводился адрес Места при снятой галочке строка с адресом должна содержать в 📍</li>
                <li>Чтобы в канал не выводилось расписание работы Места при снятой галочке строка с адресом должна содержать в 🕒</li>
            </ul>',
